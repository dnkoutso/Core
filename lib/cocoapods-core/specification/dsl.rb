...
module Pod
  class Specification
    ...
    module DSL
      ...
      SCRIPT_PHASE_OPTIONAL_KEYS = [:shell_path, :input_files, :output_files, :show_env_vars_in_log, :execution_placement].freeze

      EXECUTION_PLACEMENT_KEYS = [:before_compile, :after_compile, :any].freeze
      ...
      #   @example
      #
      #     spec.script_phase = { :name => 'Hello World', :script => 'echo "Hello World"', :execution_placement => :before_compile }
      #
      #   @example
      #
