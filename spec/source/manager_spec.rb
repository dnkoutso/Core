  ...
  describe Source::Manager do
    ...
    describe 'In general' do
      ...
      it 'returns all the sources' do
        @sources_manager.all.map(&:name).should == %w(artsy test_cdn_repo_local test_empty_dir_repo test_local_repo
                                                      test_prefixed_repo test_repo test_repo_without_specs_dir trunk)
      end
      ...
      it 'includes all sources in an aggregate for a dependency if no source is specified' do
        ...
        aggregate.sources.map(&:name).should == %w(artsy test_cdn_repo_local test_empty_dir_repo test_local_repo
                                                   test_prefixed_repo test_repo test_repo_without_specs_dir trunk)
      end
